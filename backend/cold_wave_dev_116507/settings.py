"""
Django settings for cold_wave_dev_116507 project.
...
ROOT_URLCONF = 'cold_wave_dev_116507.urls'
...
WSGI_APPLICATION = 'cold_wave_dev_116507.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "cold_wave_dev_116507 API",
    "DESCRIPTION": "API documentation for cold_wave_dev_116507 App",
    "VERSION": "v1",
}
